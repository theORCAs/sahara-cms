                        ...
                        @else
                            <form class="form-horizontal" role="form" method="post" action="/{{$prefix}}">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">Phone Code</label>
                                        <div class="col-md-2">
                                            <input type="text" id="tel_kodu" name="tel_kodu" class="form-control" value="{{old('tel_kodu', $data['tel_kodu'])}}">
                                        </div>
                                    </div>
                                    <div class="form-group last">
                                        <label class="col-md-2 control-label">Active</label>
                                        <div class="col-md-6">
                                            <input type="checkbox" class="checkbox" name="flg_aktif" id="flg_aktif" value="1" {{old('flg_aktif', $data['flg_aktif']) ? " checked" : ""}}> Yes
                                        </div>
                                    </div>
                                </div>
