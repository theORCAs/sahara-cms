                            ...
                            <form class="form-horizontal" role="form" method="post" action="/{{$prefix}}">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="kisaltma" name="kisaltma" class="form-control" value="{{old('kisaltma', $data["kisaltma"])}}">
                                        </div>

                                    </div>
                                    <div class="form-group last">
                                        <label class="col-md-2 control-label">Bank Information</label>
                                        <div class="col-md-10">
                                            <textarea name="banka_bilgileri" id="banka_bilgileri" rows="5" class="form-control">{{old('banka_bilgileri', $data->banka_bilgileri)}}</textarea>
                                        </div>
                                    </div>
                                </div>
