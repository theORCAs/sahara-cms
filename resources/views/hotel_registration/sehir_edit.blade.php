...
@section('content')
    <div class="page-content">
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title"> Hotel Cities
                    ...
                    <div class="portlet-body form-horizontal">
                        ...
                        @endif
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">City Code</label>
                                    <div class="col-sm-2">
                                        <input type="text" id="plaka" name="plaka" class="form-control" value="{{old('plaka', $data["plaka"])}}">
                                    </div>
                                </div>
                                <div class="form-group">
