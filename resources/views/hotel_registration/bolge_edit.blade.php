...
@section('content')
    <div class="page-content">
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title"> Hotel Region
                        ...
                        @endif
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Region City</label>
                                    <div class="col-sm-4">
                                        <select id="sehir_id" name="sehir_id" class="select2 form-control">
                                            <option value="">Select</option>
                                            @foreach($sehirler as $sehir)
                                                <option value="{{$sehir->id}}" @if($sehir->id == old('sehir_id', $data['sehir_id'])) selected @endif>{{$sehir->adi}}</option>
                                                @endforeach
                                        </select>
                                    </div>
