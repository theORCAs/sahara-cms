...
@section('content')
    ...
    <div class="page-content">
        <!-- BEGIN PAGE HEADER-->
        <!-- BEGIN PAGE BAR -->
        <div class="page-bar {{(Auth::user()->isAllow('amp_add')) ? "" : "hidden"}}">
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">Account Module (Personel)
                            ...
                            @else
                                <table class="table table-condensed table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th> Explanation </th>
                                        <th> Given (TL) </th>
                                        <th class="text-right"> Spent (TL) </th>
                                    ...
                                    @foreach($liste as $key => $row)
                                        <tr>
                                            ...
                                            <td>{{$row->aciklama}}</td>
                                            <td></td>
                                            <td class="text-right">@money_format($row->gider_tl) <i class="fa fa-try"></i></td>
                                            <td class="text-center">
                                                @if(Auth::user()->isAllow('amp_edit'))
