                    ...
                    <div class="portlet-body form-horizontal">
                        ...
                        @endif
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Receive Type</label>
                                    <div class="col-sm-6">
                                        <select name="gelir_kalem_id" id="gelir_kalem_id" class="select2 form-control">
                                            <option value="">Select</option>
                                            @foreach($gelir_turleri as $row)
                                                <option value="{{$row->id}}" {{old('gelir_kalem_id', $data->gelir_kalem_id) == $row->id ? " selected" : ""}}>{{$row->adi}}</option>
                                                @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" id="gelir_tl" name="gelir_tl" class="form-control" value="{{old('gelir_tl', $data["gelir_tl"])}}">
                                    </div>
                                </div>
