...
@section('content')
    ...
    <div class="page-content">
        <!-- BEGIN PAGE HEADER-->
        <!-- BEGIN PAGE BAR -->
        <div class="page-bar {{(Auth::user()->isAllow('ama_receive_add')) ? "" : "hidden"}}">
                            ...
                            @else
                                <table class="table table-condensed table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th> Expense Type </th>
                                        <th> Explanation </th>
                                        <th class="text-right"> Amount (TL) </th>
                                    ...
                                    @foreach($liste as $key => $row)
                                        <tr>
                                            ...
                                            <td>{{$row->gelirKalem->adi}}</td>
                                            <td>{{$row->aciklama}}</td>
                                            <td class="text-right">@money_format($row->gelir_tl) <i class="fa fa-try"></i></td>
