...
@section('content')
    <div class="page-content">
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title"> Company/Institutions List from Contacts
                        ...
                        @endif
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="ulke_id" id="ulke_id" class="select2 form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select id="sektor_id" name="sektor_id" class="select2 form-control">
                                            <option value="">Select</option>
                                            @foreach($sektor_listesi as $row)
                                                <option value="{{$row->id}}"{{old('sektor_id', $data['sektor_id']) == $row->id ? " selected" : ""}}>{{$row->adi}}</option>
                                                @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="web_sayfasi" name="web_sayfasi" class="form-control" value="{{old('web_sayfasi', $data["web_sayfasi"])}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Not in List</label>
                                    <div class="col-sm-10">
                                        <input type="checkbox" id="flg_notinlist" name="flg_notinlist" class="form-control" value="1" {{old('flg_notinlist', $data["flg_notinlist"]) ? " checked" : ""}}> Yes
                                    </div>
                                </div>
