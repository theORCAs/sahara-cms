...
@section('content')
    ...
    <div class="page-content">
        <!-- BEGIN PAGE HEADER-->
        <!-- BEGIN PAGE BAR -->
        <div class="page-bar {{(Auth::user()->isAllow('wmo_hp_add')) ? "" : "hidden"}}">
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">Homapage Pictures
                                ...
                                <table class="table table-condensed table-hover">
                                    ...
                                    @foreach($liste as $key => $row)
                                        <tr>
                                            ...
                                            <td><a href="{{Storage::url($row->resim)}}" target="_blank"><img src="{{Storage::url($row->resim)}}" width="100"></a></td>
                                            <td>{{$row->adi}}</td>
                                        </tr>
                                    @endforeach
                                    </tbody>
