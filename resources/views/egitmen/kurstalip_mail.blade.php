...
@section('content')
    <div class="page-content">
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title"> Course Delivery Preference Mail
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-body form-horizontal">
                        <form class="form-horizontal" role="form" method="post" action="/iasMailSend" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="hidden" name="hid_kayit_id" value="{{$hid_kayit_id}}">
                                    </div>
                                </div>
                                <div class="form-group">
