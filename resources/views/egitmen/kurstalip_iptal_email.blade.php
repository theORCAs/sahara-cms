            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-body form-horizontal">
                        <form class="form-horizontal" role="form" method="post" action="/{{$prefix}}/cancelEmailStartSend" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        {!! $data['to_receive_text'] !!}
                                        <input type="hidden" name="hid_kayit_ids" value="{{$hid_kayit_ids}}">
                                    </div>
                                </div>
                                <div class="form-group">
