...
@section('content')
    <div class="page-content">
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title"> Instructor Personel Email
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-body form-horizontal">
                        <form class="form-horizontal" role="form" method="post" action="/personelEmailSend" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="hid_egitmen_id" value="{{$hid_egitmen_id}}">
                            <input type="hidden" name="guncellenecek_alan" value="{{$guncellenecek_alan}}">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="to_email" id="to_email" value="{{old('to_email', $data['to_email'])}}" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
