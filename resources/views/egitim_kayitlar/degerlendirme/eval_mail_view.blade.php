            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-body form-horizontal">
                        <form class="form-horizontal" role="form" method="post" action="/{{$prefix}}/evaluationMailSend/{{$katilimci_id}}" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="hid_teklif_id" value="{{$teklif_id}}">
                            <input type="hidden" name="hid_egitim_kayit_id" value="{{$egitim_kayit_id}}">
                            <input type="hidden" name="hid_katilimci_id" value="{{$katilimci_id}}">
                            <div class="form-body">
