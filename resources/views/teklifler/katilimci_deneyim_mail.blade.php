            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-body form-horizontal">
                        <form class="form-horizontal" role="form" method="post" action="/{{$prefix}}/paxExperienceMailSend/{{$hid_katilimci_id}}/{{$hid_teklif_id}}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="to_email" id="to_email" value="{{trim($data["to_email"])}}">
                                </div>
                                <div class="form-group">
