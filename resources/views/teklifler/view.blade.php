            ...
            <div class="col-md-6">
                <div class="portlet box blue">
                    ...
                    <div class="portlet-body" style="display: none;">
                        <form id="filtre_form" class="form-horizontal" method="post" action="{{$prefix}}/search">
                            @csrf
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Year</label>
                                    <div class="col-md-4">
                                        <select id="filtre_yil" name="filtre_yil" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <select id="filtre_ulke_id" name="filtre_ulke_id" class="form-control">
                                            <option value="0">Select</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <select id="filtre_hoca_odeme" name="filtre_hoca_odeme" class="form-control">
                                            <option value="0">Select</option>
                            ...
                            @else
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    @foreach($liste as $key => $row)
                                        ...
                                        <tr class="@if($row->flg_odendi == "1") sh-bg-green-light @else perzeli @endif">
                                            <td>{{$key+1}}</td>
                                            <td>
                                                <div>ID: {{$row->id}}</div>
                                                    ...
                                                    <table>
                                                        ...
                                                        @for($hgun = 0; $hgun < $row->egitimKayit->egitimTarihi->egitim_suresi; $hgun++)
                                                            ...
                                                            @php($atanma_durum = $row->guneHocaAtanmismi(date('Y-m-d', strtotime($row->egitimKayit->egitimTarihi->baslama_tarihi." +$hgun day"))) )
                                                                {!! $hgun % 5 == 0 ? "<br>" : "" !!}
                                                            <div class="{{(int)$atanma_durum["atanmis"] > 0 ? 'secili-gun' : 'secili-degil-gun'}} text-center float-left"
                                                                 style="float: left">{{$egitim_tarih}}<br>{{$atanma_durum["hoca_kisa_adi"]}}</div>
                                                        @endfor
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                @foreach($row->egitimHocalar as $hoca_row)
                                                    ...
                                                    <div>
                                                        ...
                                                        <a href="/{{$prefix}}/coursePaymentMailView/{{$hoca_row->id}}" style="text-decoration: underline;">
                                                            @if($hoca_row["flg_odeme_yapildi"] == '0')
                                            ...
                                            <td>
                                                ...
                                                <div>
                                                    ...
                                                    @endif
                                                    / <a href="javascript:;" onclick="yorumYazModal('{{$row->id}}')" class=" {{$row->yorum != "" ? 'font-red' : ''}}" id="yorum_href_{{$row->id}}">Comment</a>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <div>
                                                    @if($row->katilimciResimleri->count() > 0)
                                                        <a href="/participantPhoto/{{$row->id}}" class="font-green" target="_blank">Add Photo [{{$row->katilimciResimleri->count()}}]</a>
                                                        @else
                                                        <a href="/participantPhoto/{{$row->id}}" class="font-red" target="_blank">Add Photo</a>
                                                    @endif
                                                </div>
                                                <div>
                                                    @if($row->teklifFormlar(1)->count() > 0)
                                                        <a href="/teklifFormlar/{{$row->id}}/1" class="font-green" target="_blank">Add Evaluation [{{$row->teklifFormlar(1)->count()}}]</a>
                                                        @else
                                                        <a href="/teklifFormlar/{{$row->id}}/1" class="font-red" target="_blank">Add Evaluation</a>
                                                    @endif
                                                </div>
                                                <div>
                                                    @if($row->teklifFormlar(2)->count() > 0)
                                                        <a href="/teklifFormlar/{{$row->id}}/2" class="font-green" target="_blank">Add Attandence [{{$row->teklifFormlar(2)->count()}}]</a>
                                                        @else
                                                        <a href="/teklifFormlar/{{$row->id}}/2" class="font-red" target="_blank">Add Attandence</a>
                                                    @endif
                                                </div>
                                            </td>
                                        </tr>
...
@section("css")
    ...
    <style type="text/css">
        ...
        .sh-bg-green-light{
            background-color: #E3FCDC !important;
        }
    </style>
@endsection
@section("js")
                ...
                if(result) {
                    ...
                    $.get('/{{$prefix}}/teklifOdemeDurumDegistirJson/' + teklif_id + "/" + flg_odendi, function (cevap) {
                        ...
                        if(flg_odendi == "1") {
                            ...
                            $("#odeme_durum_" + teklif_id).closest('tr').addClass('sh-bg-green-light');
                            ...
                            $("#odeme_durum_" + teklif_id).closest('tr').removeClass('sh-bg-green-light');
