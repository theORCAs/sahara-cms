...
@section('content')
    <div class="page-content">
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title"> Course CANCEL Email
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-body form-horizontal">
                        <form class="form-horizontal" role="form" method="post" action="/{{$prefix}}/coursePaymentMailSend/{{$hid_egitim_hoca_id}}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Payment Made</label>
                                    <div class="col-sm-1">
                                        <input type="text" id="ucret" name="ucret" class="form-control" value="{{old('ucret', $data["ucret"])}}">
                                    </div><div class="col-sm-3">
                                        <input type="checkbox" id="mail_gonder" name="mail_gonder" class="form-control" value="1" checked> Send Email
                                    </div>
                                </div>
                                <div class="form-group">
