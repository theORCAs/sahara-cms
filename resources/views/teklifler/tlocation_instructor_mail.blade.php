...
@section('content')
    <div class="page-content">
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title"> Training Location Email
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-body form-horizontal">
                        <form class="form-horizontal" role="form" method="post" action="/{{$prefix}}/tLocationInstructorMailSend/{{$hid_teklif_id}}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Instructor(s)</label>
                                    <div class="col-sm-6">
                                        @foreach($hocalar_listesi as $row)
                                            <div><input type="checkbox" name="secili_email[]" id="secili_email" class="form-control" value="{{$row->email}}" checked> {{$row->adi_soyadi." < $row->email >"}}</div>
                                            @endforeach
                                    </div>
                                </div>
                                <div class="form-group">
