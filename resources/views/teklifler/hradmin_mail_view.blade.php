...
@section('content')
    <div class="page-content">
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title"> HR/Admin Email
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-body form-horizontal">
                        <form class="form-horizontal" role="form" method="post" action="/{{$prefix}}/hrAdminMailSend/{{$hid_teklif_id}}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">HR/Admin</label>
